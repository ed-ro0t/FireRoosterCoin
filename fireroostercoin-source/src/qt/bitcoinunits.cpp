...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FireRoosterCoins");
    case mBTC: return QString("Milli-FireRoosterCoins (1 / 1,000)");
    case uBTC: return QString("Micro-FireRoosterCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
